...
const divideByTwo2 = numbers.map(elm => elm / 2)
 console.log(divideByTwo2)
//  divideByTwo2
////////// PROBLEM 3 //////////
...
const citiesEndingInI = cities.filter(elm => elm.endsWith(`i`))
...
// The fruit with index 0 is neither appl
// e or orange.
// The fruit with index 1 is an orange.  
// The fruit with index 2 is neither appl
// e or orange.
// The fruit with index 3 is an apple.
...
const totalRice = foods.filter(elm => elm.tags.includes(`rice`)).reduce((acc, cuur,) => (acc + cuur.price), 0)
